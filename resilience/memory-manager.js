...
export class MemoryManager {
    constructor(options = {}) {
        ...
        this.gcHints = {
            ...
            forceGCThreshold: options.forceGCThreshold ?? 0.90
        };
    ...
    performAdaptiveCleanup(availableLimits) {
        ...
        const pressure = this.metrics.currentPressure > 0 ? 
            this.metrics.currentPressure : this.measurePressure();

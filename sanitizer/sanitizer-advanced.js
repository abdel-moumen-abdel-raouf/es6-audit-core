...
class AdvancedEncodingDetector {
    ...
    tryDecodeBase64(str) {
        try {
            ...
            if (!this.encodingMarkers.base64.test(str) && 
                !this.encodingMarkers.base64Url.test(str)) {
                return null;
            }
...
class AdvancedSanitizer {
    ...
    sanitizeValue(value, depth = 0, parentKey = '') {
        ...
        if (typeof value === 'string') {
            ...
            if (this.encodingDetector.containsSensitiveKeywords(value) && 
                parentKey && this.isSensitiveKey(parentKey)) {

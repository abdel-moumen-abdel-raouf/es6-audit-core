    ...
    getStatistics() {
        return {
            ...
            workerStats: this.workers.map(w => ({
                ...
                averageProcessTime: w.tasksCompleted > 0 ? (w.totalProcessTime / w.tasksCompleted).toFixed(2) : 0
            }))
        };
    }
...
export class TraceExporter {
    ...
    async exportTrace(trace) {
        ...
        const span = {
            ...
            references: trace.parentSpanId ? [{ refType: 'CHILD_OF', traceID: trace.traceId, spanID: trace.parentSpanId }] : [],
